    ...
    <section id="about" className="bg-background py-16 sm:py-20 lg:py-28">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-4 sm:gap-12 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <motion.div
          ...
          className="max-w-xl lg:justify-self-start"
        >
          <span className="inline-flex rounded-[var(--radius-md)] bg-primary/10 px-3.5 py-1.5 text-xs font-semibold tracking-[0.14em] text-primary uppercase">
            Since 2015
          </span>

          <h2 className="font-heading mt-5 text-3xl leading-tight font-semibold text-text sm:text-4xl lg:text-[2.5rem]">
